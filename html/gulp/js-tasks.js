...
// creatiixDesign js move task
gulp.task('js:move-creatiixDesign', () => {
  const obj = gulpHelper.find(paths, 'default')
  return gulpHelper.uglify(['src/assets/js/creatiixDesign-script/*.js'], obj.dir)
})

// Main js move task
gulp.task('js:move', gulp.series(jsMoveTask(), 'js:move-creatiixDesign'));
